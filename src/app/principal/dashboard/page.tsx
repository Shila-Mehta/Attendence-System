...
/** Title Case a status string: "Awaiting parent" → "Awaiting Parent" */
    ...
    >
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <KpiCard
          ...
          sub={`${principalKpis.unexplainedCount} unexplained`}
          tone="danger"
        />
        <KpiCard
          ...
          <div className="p-4 sm:p-5">
            ...
            <ul className="mt-5 space-y-2">
              <StatusLine
                label="Submitted"
                value={
                  classStatuses.filter((c) => c.status === "Submitted").length
                }
                tone="success"
              />
              <StatusLine
      ...
      <section className="rounded-lg border border-border bg-surface">
        ...
        {unexplainedSummary.length === 0 ? (
          ...
          <>
            ...
            <div
              className="
                hidden md:grid items-center gap-3
                px-4 sm:px-5 py-2.5
                border-b border-border
                bg-muted/20
                text-[11px] uppercase tracking-wider text-muted-foreground
                md:grid-cols-[minmax(0,1fr)_200px_150px]
              "
            >
              <div>Student</div>
              <div>Guardian</div>
            ...
            <ul className="divide-y divide-border">
              {unexplainedSummary.map((u) => (
                <li
                  key={u.id}
                  className="
                    grid items-center gap-3 px-4 sm:px-5 py-4
                    grid-cols-1
...
function CountBox({
  ...
  return (
    <div className="rounded-md border border-border bg-background p-3 text-center">
      ...
      <div className={`mt-1 text-lg sm:text-xl font-semibold ${cls} tabular-nums`}>
        {value}
      </div>
    </div>
  );
...
function KpiCard({
  ...
  return (
    <div className="rounded-lg border border-border bg-surface p-3 sm:p-4">
      ...
      <div
        className={`mt-1 text-xl sm:text-2xl font-semibold tabular-nums ${cls}`}
      >
        {value}
      </div>
      {sub && (
